...
export default function RegisterPage() {
  ...
  const onSubmit = async (e: FormEvent) => {
    ...
    console.log("Tentative d'inscription avec:", { name: form.name, email: form.email });
    
    try {
      await register(form.name, form.email, form.password, form.password_confirmation);
      setSuccess("Compte créé avec succès! Redirection...");
      console.log("Inscription réussie, redirection vers:", redirect);
  ...
  return (
    <div className="min-h-screen bg-[#050912] text-white">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_10%_20%,rgba(255,255,255,0.06),transparent_35%),radial-gradient(circle_at_80%_0%,rgba(123,151,210,0.18),transparent_32%),radial-gradient(circle_at_60%_70%,rgba(40,71,117,0.28),transparent_40%)]" aria-hidden />
