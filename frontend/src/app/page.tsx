    ...
    <div className="relative min-h-screen overflow-hidden bg-transparent text-white">
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-col gap-10 px-6 pb-16 pt-8 sm:px-10 lg:pb-20">
        <header className="flex items-center justify-between py-4">
          ...
          >
            <div className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 transition group-hover:bg-white/15">
              <span className="text-xl">◇</span>
            </div>
            <div className="flex flex-col leading-tight">
              <span className="text-base font-bold sm:text-lg">Nexi Shop</span>
          ...
          <nav className="hidden items-center gap-6 text-sm text-white/80 sm:flex">
            ...
            <a className="relative transition hover:text-white after:absolute after:left-0 after:-bottom-1 after:h-[2px] after:w-0 after:bg-[var(--primary)] after:transition-all after:duration-200 hover:after:w-full" href="/autres-jeux">Autres jeux disponibles</a>
          </nav>
        ...
        >
          ...
          <div className="relative w-full">
            ...
            <div className="relative overflow-hidden rounded-[26px] border border-white/15 bg-gradient-to-br from-white/10 via-white/5 to-white/0 shadow-2xl">
              <Image
                src={heroImage}
                alt="Diamants"
        ...
        <motion.div
          className="flex items-center justify-center gap-5 text-xs font-semibold text-white/70"
          variants={sectionFade}
          initial="hidden"
          whileInView="show"
          viewport={{ once: true, amount: 0.3 }}
